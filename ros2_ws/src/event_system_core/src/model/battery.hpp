...
public:
    ...
    void updateConfig(const double designCapacity, const double initialCapacity, const double threshold) {
    ...
    bool isBatteryLow() const { return m_designCapacity < m_lowBatteryThreshold / 100 * m_designCapacity; };
