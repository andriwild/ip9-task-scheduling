...
inline const std::vector<RolePrior>& rolePriors() {
    static const std::vector<RolePrior> table = {
                          // Office, Classroom, Meeting, Kitchen, Space, Misc, Toilet
        { "Student",            0.01f, 0.12f, 0.02f, 0.01f, 0.01f, 0.10f, 0.02f },
        { "Teacher",            0.04f, 0.09f, 0.10f, 0.09f, 0.02f, 0.02f, 0.02f },
        { "Research Assistant", 0.08f, 0.01f, 0.08f, 0.12f, 0.08f, 0.01f, 0.02f },
        { "Employee",           0.08f, 0.01f, 0.07f, 0.10f, 0.06f, 0.02f, 0.02f },
        { "Chef",               0.12f, 0.01f, 0.09f, 0.50f, 0.06f, 0.01f, 0.02f },
    };
    return table;
}
...
inline float priorFor(const RolePrior& p, const RoomType type) {
    switch (type) {
        case RoomType::OFFICE:    return p.office;
        ...
        case RoomType::SPACE:     return p.space;
        case RoomType::ACCESS:    return p.misc;
        case RoomType::MISC:      return p.misc;
    }
    return p.misc;
}
