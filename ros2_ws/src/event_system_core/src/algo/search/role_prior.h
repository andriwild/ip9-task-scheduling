...
inline const std::vector<RolePrior>& rolePriors() {
    static const std::vector<RolePrior> table = {
        { "Student",            0.03f, 0.12f, 0.02f, 0.10f, 0.05f, 0.05f, 0.02f },
        { "Teacher",            0.04f, 0.09f, 0.10f, 0.09f, 0.05f, 0.05f, 0.02f },
        { "Research Assistant", 0.05f, 0.03f, 0.08f, 0.12f, 0.05f, 0.05f, 0.02f },
        { "Employee",           0.05f, 0.01f, 0.07f, 0.10f, 0.06f, 0.06f, 0.02f },
        { "Chef",               0.03f, 0.01f, 0.01f, 0.30f, 0.06f, 0.06f, 0.02f },
    };
    return table;
}
